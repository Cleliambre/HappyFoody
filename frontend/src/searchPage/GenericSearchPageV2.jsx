 ...
 * @constructor
 */
export default function GenericSearchPage({pageDescr, barInfo, onFilterClick, onSearchClick, paginationSize, resNumber, children}) {
    ...
    return (
        ...
        >
            ...
            <CardListV2
                resMessage = {resNumber + (resNumber>1 ? " Resultats" : " Resultat")}
            >
                {children}
            </CardListV2>
